...
export default function Home() {
  ...
  useEffect(() => {
    //esta buscando todas as categorias

    async function loadData() {
      await getListPosts();

      const category = await api.get("/api/categories?populate=media");
  ...
  useEffect(() => {
    // aqui busca se tem alguma categoria favoritada
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.main}>
        ...
        <FlatList // flex:1 aqui é para ele ocupar todo o restante da tela
          style={{ flex: 1, paddingHorizontal: 18 }} // depois do Text de de cima
